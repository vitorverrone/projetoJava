...
public class TelaInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPaneItems, javax.swing.GroupLayout.PREFERRED_SIZE, 419, Short.MAX_VALUE))
        );
        ...
        setSize(new java.awt.Dimension(621, 431));
    ...
    private void btnAtualizarProdMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAtualizarProdMouseClicked
        if(txtNomeProd.getText() == "" || txtEstoqueProd.getText() == "" || 
                txtPrecoProd.getText() == "") {
